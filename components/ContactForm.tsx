...
export default function ContactForm() {
    ...
    function Submit() {
        ...
        return <button
            className="w-full px-4 py-2 bg-blue-900 text-white rounded hover:bg-blue-950 focus:outline-none"
        ...
        <form action={formAction} ref={formRef} className="max-w-md mx-auto text-black">
            ...
            <div className="mb-4">
                ...
                <input
                    ...
                    className="mt-1 p-2 border text-white rounded-md w-full"
                />
            </div>
            <div className="mb-4">
            ...
            <div className="mb-4">
                ...
                <div>
                    {accommodationChoices.map((value, index) => {
                        return (
                            <ul id={value} className={'text-blue-950'} key={index}><input type={'checkbox'}/> {value}
                            </ul>)
                    })}
                </div>
            </div>
            <div id={'tattoo portion of form'}>
                <h2 className={'text-4xl font-extrabold text-blue-950'}>Tattoo Details</h2>
                <div className="mb-4">
