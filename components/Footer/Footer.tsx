    ...
    return (
            ...
            <footer className="relative">
                <div className="footer-height text-center">
                    ...
                    <button><a className="p-6 mx-4 bg-blue-500 w-30 rounded-full block mb-2 text-white"><Link href={'https://ensonpokes.storenvy.com/'}>Shop Merch</Link></a>
                    </button>
                    <Link href={"https://www.instagram.com/ensonpokes"} className="flex w-12 h-12 mx-auto my-4">
                    ...
                    <h6 className="footer-title pb-2">
                        ...
                        <a href="https://www.linkedin.com/in/rkarkare/" className="px-4 text-white text-xs">rutvi karkare</a>
                        <a href="https://www.linkedin.com/in/eleazarfhernandez/" className="px-4 text-white text-xs">eleazar hernandez</a>                    
                    </h6> 
                </div>
            </footer>
            </>
